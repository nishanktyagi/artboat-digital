    ...
    <div className="min-h-screen">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20">
          ...
          >
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 to-white">
              That Sell — For Brands Ready to Grow
            </span>
          </motion.h1>
          ...
          >
            From store setup to scaling — ArtBoat Digital is the Shopify growth partner for ambitious e-commerce brands across Asia, LATAM, Africa & the Middle East.
          </motion.p>
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-white text-purple-600 px-8 py-4 rounded-lg font-semibold hover:shadow-2xl transition-all flex items-center justify-center gap-2"
            >
              Build My Shopify Store <ArrowRight size={20} />
            </motion.button>
            <a
              href="#portfolio"
            ...
            {services.map((service, index) => (
              ...
              >
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4 w-14 h-14 bg-white rounded-xl flex items-center justify-center text-purple-600">
                    {service.icon}
                  </div>
                </div>
                <div className="p-8">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-gray-900">
              Why Shopify is the #1 Platform for Your E-commerce Brand
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Shopify powers the world's fastest-growing e-commerce brands — from startups to enterprises across emerging markets.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            >
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-2xl font-semibold mb-2 text-gray-900">Reach a Global Audience</h3>
                  <p className="text-gray-600">
                    Digital marketing breaks geographical barriers, allowing you to connect with potential customers worldwide. Your business can operate 24/7, reaching audiences across different time zones and markets.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-2xl font-semibold mb-2 text-gray-900">Targeted Marketing</h3>
                  <p className="text-gray-600">
                    Reach the right people at the right time. Digital marketing allows precise targeting based on demographics, interests, behaviors, and search intent, ensuring your message reaches those most likely to convert.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-2xl font-semibold mb-2 text-gray-900">Measurable Results</h3>
                  <p className="text-gray-600">
                    Track every click, impression, and conversion. Digital marketing provides real-time analytics and insights, allowing you to measure ROI accurately and optimize campaigns for maximum performance.
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            {[
              {
                ...
                description: 'Digital marketing delivers higher ROI compared to traditional marketing, with lower costs and better targeting capabilities.',
              },
              {
                icon: <Users className="w-8 h-8" />,
                title: 'Customer Engagement',
                description: 'Build meaningful relationships through social media, email, and content marketing, fostering brand loyalty and trust.',
              },
              {
                icon: <Zap className="w-8 h-8" />,
                title: 'Quick Results',
                description: 'See immediate impact from your campaigns. Adjust strategies in real-time based on performance data and market trends.',
              },
              {
                icon: <Smartphone className="w-8 h-8" />,
                title: 'Mobile-First Reach',
                description: 'Connect with customers on their smartphones. Mobile marketing ensures you reach users wherever they are, whenever they need you.',
              },
            ].map((benefit, index) => (
              <motion.div
                key={index}
              ...
              >
                <div className="w-16 h-16 bg-gradient-to-br from-purple-600 to-blue-500 rounded-xl flex items-center justify-center text-white mb-4">
                  {benefit.icon}
                </div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="mt-16 bg-gradient-to-br from-purple-600 to-blue-600 rounded-3xl p-12 text-white"
          >
            <h3 className="text-3xl font-bold text-center mb-12">Shopify by the Numbers</h3>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              <div className="text-center">
                <div className="text-5xl font-bold mb-2">500M+</div>
                <div className="text-purple-100">Shopify GMV in Asia-Pacific 2024</div>
              </div>
              <div className="text-center">
                <div className="text-5xl font-bold mb-2">73%</div>
                <div className="text-purple-100">Prefer Mobile-Optimized Stores</div>
              </div>
              <div className="text-center">
                <div className="text-5xl font-bold mb-2">3x</div>
                <div className="text-purple-100">Average Revenue Growth on Shopify</div>
              </div>
              <div className="text-center">
                <div className="text-5xl font-bold mb-2">ROI 8:1</div>
                <div className="text-purple-100">Shopify Brands Meta + Google ROAS</div>
              </div>
            </div>
          </motion.div>
        </div>
